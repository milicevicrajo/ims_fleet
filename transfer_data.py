...
def transfer_all_data():
    ...
    models_to_transfer_second = [JobCode, Lease, LeaseInterest, Policy, FuelConsumption, Incident, PutniNalog, Service, ServiceTransaction, Requisition, TransactionOMV, TransactionNIS]
