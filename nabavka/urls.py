...
from .views.invoices import (
    ...
    ProcurementInvoiceLinkListView,
)
...
urlpatterns = [
    ...
    path("euf-fakture/<str:euf_key>/povezi/", EufInvoiceLinkView.as_view(), name="euf_invoice_link"),
    path("povezane-fakture/", ProcurementInvoiceLinkListView.as_view(), name="invoice_link_list"),
    path("povezane-fakture/<int:pk>/obrisi/", ProcurementInvoiceLinkDeleteView.as_view(), name="invoice_link_delete"),
