...
urlpatterns = [
    ...
    path(
        "<int:pk>/dokumenti/dodaj/",
        ContractDocumentCreateView.as_view(),
        name="contract_document_create",
    ),
    path(
        "<int:pk>/dokumenti/<int:document_pk>/obrisi/",
        ContractDocumentDeleteView.as_view(),
        name="contract_document_delete",
    ),
