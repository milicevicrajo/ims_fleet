...
from .views import (
    ...
    ContractDeleteView,
    ContractDetailView,
    ContractGuaranteeCreateView,
    ContractGuaranteeDeleteView,
    ContractListView,
    ContractMenicaLinkCreateView,
    ContractMenicaLinkDeleteView,
...
urlpatterns = [
    ...
    path("partneri/sync-apr/start/", sync_apr_partneri_start, name="partner_sync_apr_start"),
    path("partneri/sync-apr/batch/", sync_apr_partneri_batch, name="partner_sync_apr_batch"),
    ...
    path("partneri/<int:pk>/apr-update/", partner_apr_update, name="partner_apr_update"),
    ...
    path("<int:pk>/menice/dodaj/", ContractMenicaLinkCreateView.as_view(), name="contract_menica_link_create"),
    path("<int:pk>/menice/<int:link_pk>/obrisi/", ContractMenicaLinkDeleteView.as_view(), name="contract_menica_link_delete"),
    path("<int:pk>/garancije/dodaj/", ContractGuaranteeCreateView.as_view(), name="contract_guarantee_create"),
    path("<int:pk>/garancije/<int:guarantee_pk>/obrisi/", ContractGuaranteeDeleteView.as_view(), name="contract_guarantee_delete"),
