...
urlpatterns = [
    ...
    path('neodobrene-if/', neodobrene_if_izvestaj, name='neodobrene_if_izvestaj'),
    path('naplata/export-excel/', export_dugovanja_bucketi_excel, name='export_dugovanja_excel'),
    path('naplata/neodobrene-if/export-excel/', export_neodobrene_if_excel, name='export_neodobrene_if_excel'),
